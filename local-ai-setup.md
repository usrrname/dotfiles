...
Mac OS: https://docs.ollama.com/macos
...
[Setting Environment Variables on macOS](https://docs.ollama.com/faq#setting-environment-variables-on-mac)

Example:
```
export OLLAMA_HOST="0.0.0.0:11434" <ollama command>
